...
export default function Gallery() {
    return (
		<section className="p-12 xl:px-[148px] xl:py-[123px] font-heading">
			<div>
				<h1 className="text-2xl font-bold mb-2 text-[#028141] xl:text-[56px] xl:mb-10">
					Gallery
				</h1>
				<div className="flex flex-col gap-2">
					<div className="flex flex-col md:flex-row gap-2 xl:gap-6">
						<Link href="https://www.youtube.com/watch?v=x7Op3VT6Ezs&ab_channel=TheNewFieldsSTEMSchoolofDavao">
							<h1 className="mb-0.5 xl:my-2 xl:text-[20px] text-sm text-[#333333]">
