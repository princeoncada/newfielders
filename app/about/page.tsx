		...
		<div className="bg-[#F0F0F0]">
			...
			<div className="flex flex-row px-8 lg:px-28 h-auto relative bottom-16 gap-5 max-w-[1280px] mx-auto">
				...
				<section className="bg-white w-full lg:2/3 p-8 flex flex-col gap-5 lg:gap-8 lg:py-14">
					...
					<article id="team-section" className="flex flex-col gap-1 lg:gap-5 lg:mx-12 max-w-full">
						<h1 className="text-2xl font-semibold font-heading text-[#00582C] lg:text-4xl lg:font-bold lg:mb-1">
							The NewFields Team
						</h1>
						<div
						...
						>
							<p>
								The NewField&apos;s Team is a dedicated and dynamic
								group committed to fostering an effective and
								nurturing educational environment. Leading the
								team is Maam Helen Perpetua J. Onggo, a
								visionary directress whose inspiring leadership
								drives innovation, inclusivity, and academic
								excellence.
							</p>
							...
							<p>
								Under Maam Helen&apos;s leadership, the NewFields Team
								collaborates to create a harmonious educational
								ecosystem that nurtures every student&apos;s
								potential, ensuring they achieve academic
								success and develop into well-rounded
								individuals.
							</p>
						</div>
					</article>
