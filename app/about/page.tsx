			...
			<div className="flex flex-row px-8 lg:px-28 h-auto relative bottom-16 gap-5 max-w-[1280px] mx-auto">
				...
				<section className="bg-white w-full lg:2/3 p-8 flex flex-col gap-5 lg:gap-8 lg:py-14">
					<Article title="Vision" flex={false}>
						...
						citizens through a student-centered, collaborative and
						problem-based learning processes facilitated by
						passionate, knowledgeable educators trained in science,
					...
					<Article title="Mission" flex={false}>
						...
						students from early childhood through 12th grade deep
						interest, appreciation, knowledge, competencies and
						skills in science and mathematics and the technology and
						engineering design process, sharpens their analytical,
						problem-solving, experimentation, collaboration, and
						communication skills, nurtures their creative talents
						and imagination, fosters character education and good
						citizenship, and creates a culture of inquiry with their
						peers and teachers.
					</Article>
					...
					<Article title="Core Values">
						<ul className="list-decimal flex flex-col pl-4 lg:pl-7 text-start">
							...
							<ul className="list-[lower-alpha] pl-4 text-[14px] lg:text-[18px]">
								...
								<li>
									Takes care of oneself by having good health
									and cleanliness habits
								</li>
								<li>
								...
								<li>
									Keeps things in order during and after work
								</li>
							...
							<ul className="list-[lower-alpha] pl-4 text-[14px] lg:text-[18px]">
								<li>
									Takes time to think about one&apos;s actions
									and their effects
								</li>
							...
							<ul className="list-[lower-alpha] pl-4 text-[14px] lg:text-[18px]">
								...
								<li>
									...
									others toward a goal/activity
								</li>
								<li>
									Accepts defeats and celebrates other&apos;s
									success
								</li>
